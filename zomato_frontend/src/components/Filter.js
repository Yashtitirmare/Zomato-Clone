...
export default function Filter() {
    ...
    useEffect(() => {
        //fetch
        fetch(`https://zomato-frontend-bdj9ldt7l-yash-titirmares-projects.vercel.app/restaurant/filter/${currentPageNo}`, requestOption)
    ...
    useEffect(() => {
        fetch("https://zomato-frontend-bdj9ldt7l-yash-titirmares-projects.vercel.app/location", { method: 'GET' })
            .then((response) => response.json())
            .then((data) => {
